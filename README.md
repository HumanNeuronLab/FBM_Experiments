...
3. Complete the required fields in the experiments pop up window, and press ok. 
4. Run the experiment to completion
...
auditory_naming
reading_completion
Visual Category Localizer folder:
CatLocalizer_images


## Executable Experiment files: 
CL = Category Localizer
LM = Funcitonal Mapping
CL_Test_v4.exe (too large to share on github)
LM_Test_v1.exe (too large to share on github)
...
## Executable background folder and files (DO NOT REMOVE FROM FOLDER):
build
dist
source
temp
